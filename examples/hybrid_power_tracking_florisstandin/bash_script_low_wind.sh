...
python3 floris_runscript.py amr_input.inp amr_standin_data_low_wind.csv >> logfloris_ol 2>&1
...
python3 floris_runscript.py amr_input.inp amr_standin_data_low_wind.csv >> logfloris_cl 2>&1

# Plot the outputs
python3 plot_output_data.py
